...
contract UpdatePerpMarketStatus_Integration_Test is Base_Test {
        ...
        givenPerpMarketIsInitialized
    {
        ...
        emit PerpsEngineConfigurationBranch.LogDisablePerpMarket(users.owner.account, fuzzMarketConfig.marketId);
        ...
        givenPerpMarketIsInitialized
    {
        ...
        vm.expectEmit({ emitter: address(perpsEngine) });
        emit PerpsEngineConfigurationBranch.LogEnablePerpMarket(users.owner.account, fuzzMarketConfig.marketId);
